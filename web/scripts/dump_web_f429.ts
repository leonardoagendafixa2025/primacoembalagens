...
const cases = [
  ...
  { name: 'caseB', L: 200, B: 120, H: 80, Ep: 3.0, H7: 60 },
  { name: 'caseC', L: 300, B: 200, H: 100, Ep: 3.0, H7: 60 },
];
...
for (const c of cases) {
  ...
  console.log(`DUMPED WEB ${c.name}: ${res.segments.length} segs, ${res.arcs?.length || 0} arcs`);
}
