...
console.log('Root panel centroid:', rootPanel.centroid);

// If we center on rootPanel centroid:
const baseCx = rootPanel.centroid.x;
const baseCz = -rootPanel.centroid.y;
tree.rootGroup.position.set(-baseCx, 0, -baseCz);
...
console.log('Full box size at 100%:', fullBox100.getSize(new THREE.Vector3()));
