      ...
      >
        {activeTab === 'dims' ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {/* Banner de Faca Personalizada Importada */}
            {(model.category === 'PERSONALIZADO' || model.id.startsWith('imported_')) && (
              <div
                style={{
                  background: 'linear-gradient(135deg, rgba(0, 210, 180, 0.12), rgba(0, 140, 255, 0.08))',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--cad-accent)', letterSpacing: 0.5 }}>
                      FACA IMPORTADA ATIVA
                    </span>
                  </div>
                  <span
                    style={{
                ...
                <div style={{ fontSize: 12, fontWeight: 600, color: '#fff', wordBreak: 'break-all' }}>
                  {model.name}
                </div>

                <div style={{ fontSize: 11, color: 'var(--cad-text-muted)' }}>
                  Deseja importar outro arquivo de faca ou substituir esta?
                </div>
                ...
                <div style={{ display: 'flex', gap: 6, marginTop: 4 }}>
                  {onOpenImportModal && (
                    <button
                      ...
                      title="Importar outro arquivo para substituir a faca atual"
                    >
                      <FileUp size={13} />
                      <span>Importar Outra Faca</span>
                    </button>
                  )}
                  ...
                  {onResetToCatalog && (
                    <button
                      ...
                      title="Voltar ao catálogo padrão de caixas"
                    >
                      <span>Catálogo</span>
                    </button>
                  )}
